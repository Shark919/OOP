...
public class TestRectangle extends JFrame {
	...
	public void testCompareTo(){
		...
		if ( lr1.r.compareTo( lr2.r )==0 )
			lr1.label = "equal = 0";
		else if ( lr1.r.compareTo( lr2.r )==1 )
			lr1.label = "bigger : 1";
		else
			lr1.label = "smaller : -1";
		rectanglesPanel.add( lr1 );
		...
		if ( lr3.r.compareTo( lr4.r )==0 )
			lr3.label = "equal = 0";
		else if ( lr3.r.compareTo( lr4.r )==1 )
			lr3.label = "bigger : 1";
		else
			lr3.label = "smaller : -1";
		rectanglesPanel.add( lr3 );
	...
	public class RectanglesPanel extends JPanel {
		...
		public void paint( Graphics g ) {
			...
			for ( int i=0; i<rects.size(); i++ ) {
				...
				int x=lr.r.getX(), y=lr.r.getY(), width=lr.r.getWidth(), height=lr.r.getHeight();
